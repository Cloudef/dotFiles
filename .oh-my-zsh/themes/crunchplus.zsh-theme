...
CRUNCH_HOST_="$fg[yellow].$(whoami)$fg[white]//$fg[green]$(uname -n) :: "
...
precmd() {
   ...
   # Put it all together
   echo ""
   echo "$CRUNCH_HOST_$CRUNCH_DIR_"
   PROMPT="$CRUNCH_TIME_$CRUNCH_RVM_$CRUNCH_PROMPT$CRUNCH_CUSTOM%{$reset_color%}"
}
